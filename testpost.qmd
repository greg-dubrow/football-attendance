...
att23_all %>%
  ...
  fmt_percent(columns = c(capacity_pct_league), decimals = 1) %>%
	cols_label(attend_avg_league = md("League Average<br>Attendance"), 
	           capacity_avg_league = md("League Average<br> Stadium Capacity"),
	           capacity_pct_league = md("League Average<br> Match Capacity"), league = "League") %>%
