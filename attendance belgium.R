...
# run function
bel_attplot <- attend_plot_comb(bel_att_23_sum)
bel_attplot
...
ggsave("images/plot_attendance_23_belgium.jpg", width = 16, height = 9,
			 units = "in", dpi = 300)
...
#
#
# # add interactivity via ggiraph or plotly
...
#RColorBrewer::brewer.pal(n = 3, name = "Set2")
...
#                                     margin = margin(0, 0, 5.5, 0))))
#
# bel_plots <- attend_plot_comb(bel_att_23_sum)
#
# bel_plots +
#   plot_layout(widths = c(1.5, 2)) +
#   plot_annotation(title = "<b>Belgian Jupiler League
...
# # embedding html in quarto doc
# ```{=html}
# <iframe width="800" height="800" src="images/plot_attendance_23_belgium_i.html"></iframe>
#   ```
